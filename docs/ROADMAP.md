...
- Produce IsaacGym-to-IsaacLab mapping. Initial docs completed.
...
- Next: keep Route A as the default. Do not add backend-specific default reward tuning. Remaining work should focus on more robots, cleaner example coverage, and rough-terrain parity while preserving the original Humanoid-Gym user experience.
